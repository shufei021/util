...
class IndexDB {
    ...
    action() {
        return __awaiter(this, arguments, void 0, function* (options = {}) {
            const { type = OperationType.ADD, dbName = this.dbName, data = {}, keyPath = this.keyPath, cb = () => { } } = options;
            try {
                // 根据操作类型执行相应的方法
                ...
                return yield this.withTransaction(mode, (store) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    switch (type) {
                        ...
                        case OperationType.REFRESH:
                            ...
                            this.db = yield this.open(dbName);
                            return this.db;
                        default:
    ...
    deleteStore(storeName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                request.onerror = (event) => {
                    const error = event.target.error;
                    reject(new IndexDBError('Failed to delete store', (error === null || error === void 0 ? void 0 : error.code) || 500));
                };
            });
        });
    }
...
class ImageHotSpot {
    ...
    initDefaultProps() {
        ...
        this.defaultProps = {
            ...
            // 热区最外层容器默认样式
            container: Object.assign({ className: "hot-container", cssText: `width: 100%; height: 100%; position: relative; border: 1px dashed #ccc; box-sizing: border-box;` }, (((_c = (_b = this.options) === null || _b === void 0 ? void 0 : _b.style) === null || _c === void 0 ? void 0 : _c.container) || {})),
            // 热区包裹默认样式
            square: Object.assign({ className: "hot-square", cssText: `width: 88px; height: 88px; background-color: rgba(20, 71, 255, 0.2); border: 1px dashed ${borderColor}; cursor: move; position: absolute; left: 0px; top: 0px; opacity: 1; box-sizing: border-box;` }, (((_e = (_d = this.options) === null || _d === void 0 ? void 0 : _d.style) === null || _e === void 0 ? void 0 : _e.square) || {})),
            // 热区内容元素默认样式
            content: Object.assign({ className: "hot-content", cssText: `display:none` }, (((_g = (_f = this.options) === null || _f === void 0 ? void 0 : _f.style) === null || _g === void 0 ? void 0 : _g.content) || {})),
            lt: Object.assign({ className: "lt", cssText: `${handleCommonStyle}cursor: nw-resize;top: -4px;left: -4px;` }, (((_j = (_h = this.options) === null || _h === void 0 ? void 0 : _h.style) === null || _j === void 0 ? void 0 : _j.lt) || {})),
            lm: Object.assign({ className: "lm", cssText: `${handleCommonStyle}cursor: e-resize;top: 50%;left: -4px;transform: translateY(-50%);` }, (((_l = (_k = this.options) === null || _k === void 0 ? void 0 : _k.style) === null || _l === void 0 ? void 0 : _l.lm) || {})),
            lb: Object.assign({ className: "lb", cssText: `${handleCommonStyle}cursor: ne-resize;bottom: -4px;left: -4px;` }, (((_o = (_m = this.options) === null || _m === void 0 ? void 0 : _m.style) === null || _o === void 0 ? void 0 : _o.lb) || {})),
            bm: Object.assign({ className: "bm", cssText: `${handleCommonStyle}cursor: n-resize;bottom: -4px;left: 50%;transform: translateX(-50%);` }, (((_q = (_p = this.options) === null || _p === void 0 ? void 0 : _p.style) === null || _q === void 0 ? void 0 : _q.bm) || {})),
            br: Object.assign({ className: "br", cssText: `${handleCommonStyle}cursor: se-resize;bottom: -4px;right: -4px;` }, (((_s = (_r = this.options) === null || _r === void 0 ? void 0 : _r.style) === null || _s === void 0 ? void 0 : _s.br) || {})),
            rm: Object.assign({ className: "rm", cssText: `${handleCommonStyle}cursor: e-resize;top: 50%;right: -4px;transform: translateY(-50%);` }, (((_u = (_t = this.options) === null || _t === void 0 ? void 0 : _t.style) === null || _u === void 0 ? void 0 : _u.rm) || {})),
            tm: Object.assign({ className: "tm", cssText: `${handleCommonStyle}cursor: n-resize;top: -4px;left: 50%;transform: translateX(-50%);` }, (((_w = (_v = this.options) === null || _v === void 0 ? void 0 : _v.style) === null || _w === void 0 ? void 0 : _w.tm) || {})),
            rt: Object.assign({ className: "rt", cssText: `${handleCommonStyle}cursor: ne-resize;top: -4px;right: -4px;` }, (((_y = (_x = this.options) === null || _x === void 0 ? void 0 : _x.style) === null || _y === void 0 ? void 0 : _y.rt) || {})),
            // 热区里面元素默认样式
            seq: Object.assign({ className: "hot-seq", cssText: `min-width: 14px; min-height: 14px; text-align: center; color: #fff; line-height: 14px; position: absolute; top: 0px; left: 0px; background-color: red; font-size: 10px;z-index:-1;cursor:default` }, (((_0 = (_z = this.options) === null || _z === void 0 ? void 0 : _z.style) === null || _0 === void 0 ? void 0 : _0.seq) || {})),
            del: Object.assign({ className: "hot-del", cssText: `width: 16px; height: 16px; position: absolute; right: -20px; top: -20px; z-index: 2; cursor: pointer;` }, (((_2 = (_1 = this.options) === null || _1 === void 0 ? void 0 : _1.style) === null || _2 === void 0 ? void 0 : _2.del) || {}))
        };
    }
    // 初始化正方形位置
    initSquarePos() {
        // 将正方形位置初始化为一个对象，包含x、y、w、h四个属性
        this.squarePos = Object.assign({ x: '0px', y: '0px', w: '80px', h: '80px' }, (this.options.squarePos || {}));
    }
    // 重置初始化
    resetInit() {
        // 将isInit设置为true
...
exports.ImageHotSpot = ImageHotSpot;
exports.add = add;
exports.addStyleCss = addStyleCss;
exports.arrayGroup = arrayGroup;
exports.arrayRestore = arrayRestore;
...
exports.bufferFileDownload = bufferFileDownload;
...
exports.reg = reg;
exports.round = round;
exports.selectTextByElement = selectTextByElement;
exports.session = session;
exports.sub = sub;
exports.sumBigNumber = sumBigNumber;
