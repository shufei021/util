export const isEqual: Function = function(a:any, b:any, checked = new Set()):boolean {
    // 提前返回不同类型的值
    ...
    if (typeof a === 'object') {
        ...
        if (Array.isArray(a) && Array.isArray(b) || Object.prototype.toString.call(a) === '[object Object]' && Object.prototype.toString.call(b) === '[object Object]') {
            ...
            // 检查每个属性是否相等
            return keysA.every((key:string, index:number) => key === keysB[index] && isEqual(a[key], b[key], checked));
        }
    }
